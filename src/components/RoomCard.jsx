...
const RoomCard = ({ room }) => {
  ...
  const description =
    ...
    room.subtitle ||
    room.overview ||
    "A premium study room with modern amenities and thoughtful design.";
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        {/* Overlay */}
        <div
          className="absolute inset-x-0 bottom-0 h-32 bg-linear-to-t from-slate-950/90 via-slate-950/30 to-transparent"
          aria-hidden="true"
        />
      ...
      <div className="flex flex-col gap-5 p-6 sm:p-7">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          {/* Booking Count */}
          <div className="inline-flex items-center justify-between rounded-3xl border border-white/10 bg-slate-900/70 px-4 py-3 text-sm text-slate-200">
