...
import { BookOpen, Mail, Lock, Loader2, ChevronRight } from 'lucide-react';
            ...
            <div className="w-full max-w-md">
                <div className="rounded-3xl border border-white/10 bg-slate-950/80 backdrop-blur-xl p-8 shadow-2xl shadow-slate-950/50">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-400">Sign in to your StudyNook account</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4 mb-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 px-4 py-2.5 text-sm font-semibold text-white hover:from-blue-600 hover:to-purple-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                                <>
                                    <Loader2 className="w-4 h-4 animate-spin" />
